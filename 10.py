"""
A ACME Inc
    -tem 500 funcionarios
    -problemas de espaço no disco do servidor de arquivos
    -adm de redes precisa saber espaço ocupado pelos usuarios
        e identificar os com maior espaço ocupado

#GERAR PROGRAMA DE UM RELATORIO.TXT

Neste arquivo, o nome do usuário possui 15 caracteres.
A partir deste arquivo, você deve criar um programa que gere um relatório, chamado "relatório.txt",
no seguinte formato:
